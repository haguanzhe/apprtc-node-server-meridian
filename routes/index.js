...
// 'apprtc-ws.webrtc.org:443', 'apprtc-ws-2.webrtc.org:443'
...
var constants = {
    ...
    WSS_HOST_PORT_PAIRS: ['218.241.151.250:8000'],
...
function getRoomParameters(req, roomId, clientId, isInitiator) {
    ...
    console.log('test001: ' + req.query['test001']);
...
router.post('/join/:roomId', function (req, res, next) {
    ...
    var clientId = req.query['username'];
